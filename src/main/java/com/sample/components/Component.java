...
abstract class Component implements Serializable {
    ...
    public Component(String componentID, String componentType, String componentName, String componentDescription, double componentPrice){
    ...
    public void setComponentDescription(String componentDescription){
        if (ComponentValidation.checkComponentDescription(componentDescription)){
            this.componentDescription = new SimpleStringProperty(componentDescription);
        }
        else {
            throw new InvalidDescriptionException("The component description is invalid. Must be between 5 and 50 characters.");
        }
    }

    public String getComponentDescription(){
        return this.componentDescription.getValue();
    }
